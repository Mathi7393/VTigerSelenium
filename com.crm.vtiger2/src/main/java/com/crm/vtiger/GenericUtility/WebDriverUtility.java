...
public class WebDriverUtility {
	...
	/**
	 * This method is used to make the web page to wait for certain time until the
	 * condition met
	 * 
	 * @param driver
	 */
	...
	/**
	 * This method is used to make the web page to wait for certain time until the
	 * condition met-element is visible
	 * 
	 * @param driver
	 * @param element
	 */
	...
	/**
	 * this method is used to make the web page to wait for certain time until the
	 * condition met-element is click able
	 * 
	 * @param driver
	 * @param element
	 */
	...
	/**
	 * this method is used to check the alert pop-up is present in the web page this
	 * method is used to check pop up is alert type or not
	 * 
	 * @param driver
	 * @param element
	 */
	...
	/**
	 * this method is used to Drag and Drop the source element to destination
	 * element
	 * 
	 * @param driver
	 */
	...
	/**
	 * This method used to switch the control to the another frame by using index
	 * value
	 * 
	 * @param driver
	 * @param index
